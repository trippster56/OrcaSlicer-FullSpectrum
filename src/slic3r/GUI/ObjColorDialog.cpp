...
const  StateColor ok_btn_bg(std::pair<wxColour, int>(wxColour(14, 137, 179), StateColor::Pressed),
...
wxBoxSizer* ObjColorDialog::create_btn_sizer(long flags)
{
    ...
    StateColor calc_btn_bg(
        std::pair<wxColour, int>(wxColour(14, 137, 179), StateColor::Pressed),
        std::pair<wxColour, int>(wxColour(61, 186, 230), StateColor::Hovered),
        std::pair<wxColour, int>(wxColour(18, 170, 224), StateColor::Normal)
    );
...
{
    auto       btn_sizer = new wxBoxSizer(wxHORIZONTAL);
    StateColor calc_btn_bg(std::pair<wxColour, int>(wxColour(14, 137, 179), StateColor::Pressed), std::pair<wxColour, int>(wxColour(61, 186, 230), StateColor::Hovered),
                           std::pair<wxColour, int>(wxColour(18, 170, 224), StateColor::Normal));
    StateColor calc_btn_bd(std::pair<wxColour, int>(wxColour(18, 170, 224), StateColor::Normal));
