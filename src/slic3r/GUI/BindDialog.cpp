...
PingCodeBindDialog::~PingCodeBindDialog() {
     ...
     : DPIDialog(static_cast<wxWindow *>(wxGetApp().mainframe), wxID_ANY, _L("Log in printer"), wxDefaultPosition, wxDefaultSize, wxCAPTION)
 {
     ...
     m_link_Terms_title->SetForegroundColour(wxColour(0x12AAE0));
     ...
     m_link_privacy_title->SetForegroundColour(wxColour(0x12AAE0));
     ...
     m_link_notice_title->SetForegroundColour(wxColour(0x12AAE0));
...
std::string icon_path = (boost::format("%1%/images/Snapmaker_OrcaTitle.ico") % resources_dir()).str();
     ...
     StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(61, 186, 230), StateColor::Hovered),
                             std::pair<wxColour, int>(wxColour(18, 170, 224), StateColor::Normal));
     m_button_unbind->SetBackgroundColor(btn_bg_green);
     m_button_unbind->SetBorderColor(wxColour(18, 170, 224));
