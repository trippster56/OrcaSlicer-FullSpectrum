...
void AMSMaterialsSetting::create()
{
    ...
    m_button_confirm->SetBorderColor(wxColour(18, 170, 224));
...
void AMSMaterialsSetting::create_panel_normal(wxWindow* parent)
{
    ...
    m_readonly_filament->SetBorderColor(StateColor(std::make_pair(0xDBDBDB, (int)StateColor::Focused), std::make_pair(0x12AAE0, (int)StateColor::Hovered),
