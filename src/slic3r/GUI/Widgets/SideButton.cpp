    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(14, 137, 179), StateColor::Pressed);
    border_color.append(wxColour(61, 186, 230), StateColor::Hovered);
    border_color.append(0x12AAE0, StateColor::Normal);
    ...
    background_color.append(wxColour(14, 137, 179), StateColor::Pressed);
    background_color.append(wxColour(61, 186, 230), StateColor::Hovered);
    background_color.append(0x12AAE0, StateColor::Normal);
