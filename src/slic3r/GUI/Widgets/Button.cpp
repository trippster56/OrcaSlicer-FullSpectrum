    ...
    : paddingSize(10, 8)
{
    background_color = StateColor(
        ...
        std::make_pair(0x3DBAE6, (int) StateColor::Hovered | StateColor::Checked),
        std::make_pair(0x12AAE0, (int) StateColor::Checked),
...
wxString btn_regular[10]  = {"#DFDFDF", "#DFDFDF", "#D4D4D4", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#262E30", "#12AAE0", "#12AAE0"};
wxString btn_confirm[10]  = {"#DFDFDF", "#12AAE0", "#3DBAE6", "#12AAE0", "#12AAE0", "#6B6A6A", "#FEFEFE", "#FEFEFE", "#3DBAE6", "#00FFD4"};
wxString btn_alert[10]    = {"#DFDFDF", "#DFDFDF", "#E14747", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#FFFFFD", "#12AAE0", "#12AAE0"};
