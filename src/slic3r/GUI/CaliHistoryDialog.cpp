    ...
    , m_show_history_dialog(show)
{
    ...
    mew_btn->SetBorderColor(wxColour(18, 170, 224));
...
void HistoryWindow::sync_history_data() {
    ...
    for (auto& result : m_calib_results_history) {
        ...
        StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(14, 137, 179), StateColor::Pressed),
            std::pair<wxColour, int>(wxColour(61, 186, 230), StateColor::Hovered),
            std::pair<wxColour, int>(wxColour(18, 170, 224), StateColor::Normal));
        edit_button->SetBackgroundColour(*wxWHITE);
        edit_button->SetBackgroundColor(btn_bg_green);
        edit_button->SetBorderColor(wxColour(18, 170, 224));
    ...
    , m_new_result(result)
{
    ...
    save_btn->SetBorderColor(wxColour(18, 170, 224));
    ...
    , m_history_results(history_results)
{
    ...
    ok_btn->SetBorderColor(wxColour(18, 170, 224));
