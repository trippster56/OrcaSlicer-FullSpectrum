    ...
    , m_mapping_tutorial_popup(AmsTutorialPopup(this))
{
    ...
    m_btn_bg_enable = StateColor(std::pair<wxColour, int>(wxColour(14, 137, 179), StateColor::Pressed), std::pair<wxColour, int>(wxColour(61, 186, 230), StateColor::Hovered),
    ...
    m_ams_backup_tip->SetForegroundColour(wxColour(0x12AAE0));
