...
static const wxColour TEXT_NORMAL_CLR = wxColour(18, 170, 224);
    ...
    :wxPanel(parent, id, pos, size, style)
{
    ...
    StateColor btn_bg(std::pair<wxColour, int>(wxColour(255, 255, 255), StateColor::Disabled), std::pair<wxColour, int>(wxColour(14, 137, 179), StateColor::Pressed),
                      std::pair<wxColour, int>(wxColour(61, 186, 230), StateColor::Hovered), std::pair<wxColour, int>(wxColour(18, 170, 224), StateColor::Enabled),
                      std::pair<wxColour, int>(wxColour(18, 170, 224), StateColor::Normal));
    StateColor btn_bd(std::pair<wxColour, int>(wxColour(144, 144, 144), StateColor::Disabled), std::pair<wxColour, int>(wxColour(18, 170, 224), StateColor::Enabled));
